...
def get_net_liquidation():
    ...
    #net_liquidation = float([value for (key, value, currency, account) in accounting_values if key == 'NetLiquidation'][0])
    ...
    try:
        ...
        print("Normal IB end bug: ", e)
    net_liquidation = float([t[1] for t in accounting_values if t[0] == 'NetLiquidation' and t[2] == 'USD'][0])
    print("==================")
