...
def main():
    ...
    capital_file = path + 'admin/capital_test/capital.csv'
    '''
    ...
    report_path = admin_path  + 'reports/' +  today
...
if __name__ == "__main__":
    ...
    positions_file = admin_path + 'positions/system.csv'
    history_file = admin_path + 'positions/history/' + today + "system.csv"
    capital_file = admin_path + 'capital/capital.csv'
    logging_file = admin_path + 'info.log'
